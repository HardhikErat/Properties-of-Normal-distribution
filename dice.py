...
fig.add_trace(go.Scatter(x=[first_std_deviation_start, first_std_deviation_end], y=[0, 0.17], mode="lines", name="STANDARD DEVIATION 1"))
...
fig.add_trace(go.Scatter(x=[third_std_deviation_start, third_std_deviation_end], y=[0, 0.17], mode="lines", name="STANDARD DEVIATION 3"))
fig.show()
...
print("Standard Deviation of the given data is {}".format(std_deviation))
